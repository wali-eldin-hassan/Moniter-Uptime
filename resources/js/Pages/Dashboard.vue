    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <form class=" bg-white overflow-hidden shadow-sm sml:rounded-lg flex items-center p-3 mt-4 space-x-2">
                    <div class="grow">
                    ...
                    <div>
                        ...
                        <select name="frequency" id="frequency"
                            ...
                            <option :value="frequency.frequency" v-for="frequency in endpointsFrequencies.data" :key="frequency.frequency">
                                {{ frequency.label }}
                            </option>
                        </select>
                    </div>
